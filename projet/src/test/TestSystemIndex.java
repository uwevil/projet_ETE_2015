...
public class TestSystemIndex {
	...
	public static void main(String[] args) throws ErrorException 
	{
		...
		//	WriteFile w = new WriteFile("/Users/dcs/vrac/test/bf_description", false);
			...
			SystemIndex systemIndex = new SystemIndex(0, null, systeme.Configuration.gamma);
			...
			*/
			...
			time = System.currentTimeMillis();
			PrintWriter pw = new PrintWriter("/Users/dcs/vrac/test/overview-13-07-"
			...
			//serializable.writeObject(systemIndex, "/Users/dcs/vrac/test/serializer1");
