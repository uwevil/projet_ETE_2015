...
public class TestDeserializer {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		String requete = "junction,city,city,lane,county,oregon,united,states,population,5392,2010,census";
		...
		time = System.currentTimeMillis();
		PrintWriter pw = new PrintWriter("/Users/dcs/vrac/test/resultat-search_Wiki-perf-11-07-"
